    ...
    return (
        <div className='fixed bg-black bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center' onClick={onClose}>
            <div onClick={(e) => e.stopPropagation()} className='w-[600px] max-w-full h-[400px] bg-white rounded-xl p-4 flex flex-col relative'>
                ...
                <p className='mt-4'>Short outtake:</p>
                <p className='mt-2 w-fit'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi architecto aspernatur fuga saepe, dolore ipsa nisi debitis voluptatum explicabo molestias, vel eveniet iste error omnis aut molestiae! Adipisci, voluptas asperiores.</p>
            </div>
        </div>
    )
}
